...
- [Description of available rules](#description-of-available-rules)
  ...
  - [bool-literal-in-expr](#bool-literal-in-expr)
    - [Examples (bool-literal-in-expr)](#examples-bool-literal-in-expr)
  ...
  - [confusing-results](#confusing-results)
    - [Examples (confusing-results)](#examples-confusing-results)
  ...
  - [epoch-naming](#epoch-naming)
    - [Examples (epoch-naming)](#examples-epoch-naming)
  ...
  - [forbidden-call-in-wg-go](#forbidden-call-in-wg-go)
    - [Examples (forbidden-call-in-wg-go)](#examples-forbidden-call-in-wg-go)
  ...
  - [unnecessary-if](#unnecessary-if)
    - [Examples (unnecessary-if)](#examples-unnecessary-if)
