...
func TestPackageDirectoryMismatch(t *testing.T) {
	...
	config := &lint.RuleConfig{Arguments: []any{map[string]any{"ignore-directories": []string{}}}}
...
func TestPackageDirectoryMismatchWithTestDirectories(t *testing.T) {
	...
	config := &lint.RuleConfig{Arguments: []any{map[string]any{"ignore-directories": []string{"testinfo", "testutils"}}}}
...
func TestPackageDirectoryMismatchWithMultipleDirectories(t *testing.T) {
	...
	config := &lint.RuleConfig{Arguments: []any{map[string]any{"ignoreDirectories": []string{"testutils", "testinfo"}}}}
