...
var (
	...
	_ = time.Date(2023, 1, 2, 3, 4, 5, 00000042, time.UTC) // MATCH /use decimal digits for time.Date nanosecond argument: octal notation with padding zeroes found: 42 (decimal) != 34 (octal): use 34 instead of 00000042/
)
