...
| [`enforce-switch-default`](./RULES_DESCRIPTIONS.md#enforce-switch-default) |  []string (defaults to enforce occurrence and position) |  Enforces consistent usage of `default` on `switch` statements. |    no    |  no   |
