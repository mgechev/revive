...
| [`use-slices-sort`](./RULES_DESCRIPTIONS.md#use-slice-sort) | n/a   | Proposes to replace calls to `sort.Ints`, `sort.Strings` and the like with their equivalents from `slices` package. |   no    |  no   |
