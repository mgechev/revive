...
| [`secrets-serialization`](./RULES_DESCRIPTIONS.md#secrets-serialization) |  []string   | Warns on exported struct fields with JSON serialization enabled that have a high chance of containing secrets |    no    |  no   |
