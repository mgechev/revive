	...
	tests := []struct {
		...
		},
		{
			...
			comments: []*ast.CommentGroup{
				{
					List: []*ast.Comment{
						{Text: "//revive:disable-line:rule1"},
					},
				},
			},
			expected: disabledIntervalsMap{
		...
		},
		{
			...
			comments: []*ast.CommentGroup{
				{
					List: []*ast.Comment{
						{Text: "//revive:disable-next-line:rule1"},
					},
				},
			},
			expected: disabledIntervalsMap{
		...
		},
		{
			...
			comments: []*ast.CommentGroup{
				{
					List: []*ast.Comment{
						{Text: "//revive:enable-next-line:rule1"},
					},
				},
			},
			expected: disabledIntervalsMap{
